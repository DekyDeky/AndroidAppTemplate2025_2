...
import com.ifpr.androidapptemplate.databinding.FragmentCampaignCreationBinding

class CampaignCreateFragment : Fragment() {
    private var _binding: FragmentCampaignCreationBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCampaignCreationBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val toolbar = binding.createCampaignToolbar
    ...
    private fun openFileChoose(){
        ...
        startActivityForResult(intent, CampaignCreateFragment.Companion.PICK_IMAGE_REQUEST)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CampaignCreateFragment.Companion.PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK
